...
**Assumptions**: [Key assumptions that should be validated before coding]
...
<Project-specific integration test commands, including scripted end-to-end coverage where applicable>

### Level 4: Manual Validation

<Feature-specific manual testing steps - API calls, UI testing, exploratory checks, etc.>

### Level 5: Additional Validation (Optional)

<MCP servers, browser automation flows, or additional CLI tools if available>

---

## MANUAL VERIFICATION CHECKLIST

- [ ] Verify the feature works in the intended user flow
- [ ] Verify edge cases and failure states
- [ ] Confirm documentation or config changes are reflected where needed

## ROLLBACK CONSIDERATIONS

- How can this change be reverted safely if needed?
- What data, migrations, or config changes require special handling?
...
When implementation is complete, the execution report should include:
- commands run
- pass/fail results
- coverage gaps
...
- Item to check:
  ...
  <exact expected output or exact result to confirm>
