...
- Decide whether the failure points to a missing rule, weak command, inadequate reference guidance, insufficient testing, missing specialized agent, or unclear planning
...
- **Reference docs or skills:** Guidance that should be added or refined for reuse
- **Specialized agents:** Cases where repeated work deserves a dedicated agent template
...
Prefer small, reusable system changes with lasting benefit. Do not change product code in this review unless explicitly asked.
